...
namespace Icod.Prefix {
	...
	public static class Program {
		...
		public static System.Int32 Main( System.String[] args ) {
			...
			System.String? prefix = System.String.Empty;
			...
			do {
				...
				} else if ( "--prefix".Equals( @switch, System.StringComparison.OrdinalIgnoreCase ) ) {
					prefix = args[ ++i ];
				} else {
					PrintUsage();
					return 1;
		...
		private static void PrintUsage() {
			...
			System.Console.Error.WriteLine( "Prefix.exe --prefix thePrefix [--input inputFilePathName] [--output outputFilePathName]" );
