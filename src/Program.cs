...
namespace Icod.Prefix {
	...
	public static class Program {
		...
		public static System.Int32 Main( System.String[] args ) {
			...
			var processor = new Icod.Argh.Processor(
				new Icod.Argh.Definition[] {
					...
					new Icod.Argh.Definition( "prefix", new System.String[] { "-p", "--prefix", "/prefix" } ),
			...
			if ( 
				( !processor.TryGetValue( "prefix", false, out var prefix ) )
				|| System.String.IsNullOrEmpty( prefix )
			) {
				PrintUsage();
				return 1;
			}
		...
		private static void PrintUsage() {
			...
			System.Console.Error.WriteLine( "Prefix.exe (-h | --help | /help)" );
			System.Console.Error.WriteLine( "Prefix.exe (-c | --copyright | /copyright)" );
